              ...
              <div className="mb-10">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4 p-3 rounded-xl bg-white/30 backdrop-blur-sm">
                    ...
                    <div>
                      <h3 className="font-semibold text-[#222021]">Личный кабинет</h3>
                      <p className="text-sm text-[#4D7059]">Управление заказами и профилем</p>
                    </div>
                  </div>
                  
                  <div className="flex items-center gap-4 p-3 rounded-xl bg-white/30 backdrop-blur-sm">
                    <div className="w-10 h-10 rounded-lg bg-[#2B865A]/10 flex items-center justify-center">
                      <CheckCircle className="text-[#2B865A]" width={20} height={20} />
                    </div>
                    <div>
                      <h3 className="font-semibold text-[#222021]">Быстрый доступ</h3>
                      <p className="text-sm text-[#4D7059]">Мгновенный вход после регистрации</p>
                    </div>
                  </div>
                </div>
              </div>
