            ...
            <div className="mb-12">
              <div className="flex items-start gap-6 mb-8">
                ...
                <div className="flex-1">
                  ...
                  <p
                    className="text-base text-[#4D7059] mb-4"
                    ...
                    <div className="flex items-center gap-1">
                      {[1, 2, 3, 4, 5].map((star) => (
                        <Star
                          ...
                          width={16}
                          height={16}
                          className={star <= 4 ? 'text-[#FFC107] fill-current' : 'text-[#E0E0E0]'}
                        />
                      ))}
                    </div>
                    <span className="text-sm text-[#635436]" style={{ fontFamily: 'Manrope, sans-serif' }}>
                      4.2 (124 отзыва)
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <div className="flex items-end gap-3">
                      ...
                      {product.oldPrice && (
                        <span
                          className="text-lg line-through text-[#B4B7B5]"
                          style={{ fontFamily: 'Manrope, sans-serif' }}
                        >
                          {product.oldPrice} ₸
                        </span>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="flex items-center gap-3 bg-[#F8F8F8] rounded-full px-4 py-2">
                      <button
                        onClick={decrement}
                        className="w-8 h-8 flex items-center justify-center text-[#635436] hover:text-[#2B865A] rounded-full hover:bg-white transition-colors"
                      >
                        -
                      </button>
                      <span
                ...
                <div className="flex gap-3">
                  ...
                  >
                    <Heart
                      width={24}
                      height={24}
                      className={isFavorite ? 'text-[#FE5F55] fill-current' : 'text-[#635436]'}
                    />
                  </button>
                </div>
              </div>
            ...
            <div className="w-full rounded-2xl bg-white/90 backdrop-blur-sm shadow-xl border border-white/20 p-8">
              ...
              <div>
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button
                    onClick={() => navigate(`/categories/${product.categorySlug}/${product.subSlug}`)}
                    className="text-[#2B865A] font-semibold hover:text-[#24704A] transition-colors"
                    style={{ fontFamily: 'Manrope, sans-serif' }}
                  >
                    Все товары →
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    <Heart
                      width={20}
                      height={20}
                      style={{ color: isFavorite ? '#FE5F55' : '#FFFFFF' }}
                    />
                  </button>
                </div>
              </div>
              ...
              <div className="px-4 pt-4">
                <div className="relative">
                  <img
                    src={product.image}
                    alt={product.title}
                    className="w-full h-48 object-contain mb-4 rounded-xl bg-white p-4 shadow-sm"
                  />
                  {product.oldPrice && (
                    <div
                      className="absolute top-2 right-2 px-3 py-1 rounded-full bg-[#FE5F55] text-white text-xs font-semibold"
                      style={{ fontFamily: 'Manrope, sans-serif' }}
                    >
                      Скидка
                    </div>
                ...
                <div className="mb-6">
                    ...
                    {(
                      ...
                      <button
                        ...
                        style={{
                          ...
                          borderBottom:
                            activeTab === tab.key ? '2px solid #2B865A' : '2px solid transparent',
                          paddingBottom: '4px',
                          paddingLeft: '8px',
                          paddingRight: '8px',
                          whiteSpace: 'nowrap',
                  ...
                  <div
                    className="mt-3 text-sm p-3 bg-[#FCF8F5] rounded-xl"
                    style={{ fontFamily: 'Manrope, sans-serif', color: '#222021' }}
                  >
                    {activeTab === 'instruction' && (
                      <>
